...
/**
 * Stores every chat the user is in. Only the last message sent in
 * ({@link Chat.messages}) is stored. Group chats don't store their participants
 * in {@link GroupChat.users}.
 */
export namespace ChatsSlice {
  ...
  /**
   * Selects every chat the user is in excluding private chats with blocked
   * users.
   */
  ...
  /**
   * If the specified chat has been fetched, and it has a last message, it'll
