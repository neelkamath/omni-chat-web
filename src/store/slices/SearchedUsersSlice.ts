...
export namespace SearchedUsersSlice {
  ...
  export interface State extends ReturnType<typeof adapter.getInitialState> {
    /**
     * The query users were searched by. `undefined` if no users have been
     * searched for yet.
     */
    readonly query?: string;
    /**
     * Pagination (i.e., {@link PageInfo} parameter). `undefined` if no
     * users have been searched for yet.
     */
