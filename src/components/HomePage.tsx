    ...
    <Row gutter={16} justify="space-around" align="middle">
      ...
      <Col span={12}>
        ...
        <List>
          ...
          <List.Item>
            Broadcast chats where only admins can message. This option can be
            toggled for a chat any time. This is for chats for updates, like a
            conference&apos;s chat where you don&apos;t want hundreds of people
            asking the same questions over and over again.
          </List.Item>
          <List.Item>
            Public chats such as an official Android chat, random groups
            individuals have created, and a Mario Kart chat. People can search
            for, and view public chats without an account. Anyone with an
            account can join them.
          </List.Item>
        </List>
      </Col>
    </Row>
    ...
    <Row gutter={16} justify="space-around" align="middle">
      <Col span={12}>
        ...
        <List>
          ...
          <List.Item>
            Newly added participants can view previously sent messages.
          </List.Item>
  ...
  return (
    <Row gutter={16} justify="space-around" align="middle">
      <Col span={12}>
        ...
        <List>
          <List.Item>
            Send texts, audio, pictures, videos, polls, documents, group chat
            invites, and actions (buttons which trigger third-party server-side
            code such as ordering food via a bot).
          </List.Item>
          <List.Item>Forward messages.</List.Item>
          <List.Item>Search messages.</List.Item>
          <List.Item>
            See when the message was sent, delivered, and read.
          </List.Item>
  ...
  return (
    <Row gutter={16} justify="space-around" align="middle">
      ...
      <Col span={12}>
        ...
        <List>
          <List.Item>
            Omni Chat can be deployed for private use as well. For example, a
            company may only want to use it as an internal platform, in which
            case they can specify that only certain email address domains can
            create accounts. This way, even if an intruder gets into the
            company&apos;s network, they won&apos;t be able to create an account
            since they won&apos;t have a company issued email address. This
            feature also prevents employees from creating an account with their
            personal email address. Here are the instructions to{' '}
            <Typography.Link
              href="https://github.com/neelkamath/omni-chat-backend"
              target="_blank"
            >
          ...
          <List.Item>
            Create and use bots which give power to restaurant owners, customer
            service representatives, DevOps teams, etc. Bots can have buttons so
            that integrations can easily execute code. For example, if a Travis
            CI build fails, a bot could message the specifics on the group with
            a button, which when clicked, automatically reruns the CI/CD
            pipeline.
          </List.Item>
          <List.Item>
            This project is open-source, and allows bots and UI integrations to
            be built.
          </List.Item>
        </List>
      </Col>
