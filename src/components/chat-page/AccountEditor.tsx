...
function ProfilePic(): ReactElement {
  ...
  const url = useSelector((state: RootState) =>
    PicsSlice.selectPic(state, 'PROFILE_PIC', userId, 'ORIGINAL')
  );
  ...
  if (url === undefined) return <Spin size="small"/>;
    ...
    return <Typography.Text>No profile picture set.</Typography.Text>;
  ...
  return (
    <>
      <Typography.Paragraph>
        If you update your email address, you&apos;ll be logged out since
        you&apos;ll have to verify your new email address.
      </Typography.Paragraph>
      <UpdateAccountForm/>
    </>
  );
