...
// @ts-ignore: Cannot find module '../../static/illustrations/female_avatar.svg' or its corresponding type declarations.
import femaleAvatarImage from '../../static/illustrations/female_avatar.svg';
// @ts-ignore: Cannot find module '../../static/online_discussion.svg' or its corresponding type declarations.
import onlineDiscussionImage from '../../static/illustrations/online_discussion.svg';
// @ts-ignore: Cannot find module '../../static/illustrations/group_chat.svg' or its corresponding type declarations.
import groupChatImage from '../../static/illustrations/group_chat.svg';
// @ts-ignore: Cannot find module '../../static/illustrations/video_call.svg' or its corresponding type declarations.
import videoCallImage from '../../static/illustrations/video_call.svg';
// @ts-ignore: Cannot find module '../../static/illustrations/messaging_fun.svg' or its corresponding type declarations.
import messagingFunImage from '../../static/illustrations/messaging_fun.svg';
// @ts-ignore: Cannot find module '../../static/illustrations/chat_bot.svg' or its corresponding type declarations.
import chatBotImage from '../../static/illustrations/chat_bot.svg';
// @ts-ignore: Cannot find module '../../static/cover.png' or its corresponding type declarations.
    ...
    return (
        <HomeLayout>
            <Space direction='vertical'>
                <Image preview={false} src={coverImage} alt='Logo'/>
            ...
            <Col span={12}>
                ...
                <List>
                    ...
                    <List.Item>
                        ...
                        Mario Kart chat. People can search for, and view public chats without an account. Anyone with an
        ...
        <Row gutter={16} justify='space-around' align='middle'>
            ...
            <Col span={12}>
                ...
                <List>
                    ...
                    <List.Item>
                        Create and use bots which give power to restaurant owners, customer service representatives,
                        DevOps teams, etc. Bots can have buttons so that integrations can easily execute code. For
