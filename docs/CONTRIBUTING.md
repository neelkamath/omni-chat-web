...
1. Either run the Omni Chat 0.22.0 API [locally](https://github.com/neelkamath/omni-chat/blob/v0.22.0/docs/docker-compose.md) or in the [cloud](https://github.com/neelkamath/omni-chat/blob/v0.22.0/docs/cloud.md).
